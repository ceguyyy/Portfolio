            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var a, l, c = void 0 === s ? e.gpuAcceleration : s,
                        ...
                        m = I("transform");
                    if (l = "bottom" == p ? -h.height + u.bottom : u.top, a = "right" == g ? -h.width + u.right : u.left, c && m) f[m] = "translate3d(" + a + "px, " + l + "px, 0)", f[p] = 0, f[g] = 0, f.willChange = "transform";
                    else {
                        var _ = "bottom" == p ? -1 : 1,
                            v = "right" == g ? -1 : 1;
        ...
        an = (A = "carousel", O = "." + (S = "bs.carousel"), N = ".data-api", k = (D = e).fn[A], L = {
            ...
            return e.next = function() {
                ...
                if (!(t > this._items.length - 1 || t < 0))
                    if (this._isSliding) D(this._element).one(R.SLID, function() {
                        return e.to(t)
                    });
                    else {
                ...
                if (t === x ? (n = M, i = U, r = "left") : (n = W, i = B, r = "right"), l && D(l).hasClass(F)) this._isSliding = !1;
                ...
                return this.each(function() {
                    ...
                    if (n || (n = new t(this, i), D(this).data(S, n)), "number" == typeof e) n.to(e);
            ...
            return e.toggle = function() {
                ...
                if (!this._isTransitioning && Q(this._element).hasClass($)) {
                    ...
                    if (Q(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        if (this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", rn.reflow(this._element), Q(this._element).addClass(et).removeClass(tt).removeClass($), 0 < this._triggerArray.length)
        ...
        pn = (Be = "." + (Ue = "bs.tab"), Ke = (Me = e).fn.tab, Ve = {
            ...
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Me(this._element).hasClass(Ye) || Me(this._element).hasClass(Ge))) {
                    var e, n, i = Me(this._element).closest(Xe)[0],
